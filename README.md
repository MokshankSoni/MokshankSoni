# 💫 Hi 👋, I'm Mokshank
A final-year Information Technology student with a primary focus on **Machine Learning & Data Science**, backed by strong full-stack and backend development skills. I work with real-world datasets, build predictive models, and architect scalable backend systems. Passionate about bridging the gap between intelligent systems and production-ready applications.
...
**What I work on:**
- Supervised Learning — Regression (Linear, Ridge, Lasso), Classification (Logistic, Decision Trees, Random Forest)
- Model Evaluation — Accuracy, Precision, Recall, F1-score, Confusion Matrix
- Data Processing — Cleaning, Feature Engineering, Normalization, Handling missing values
- Time-Series Data — Multivariate datasets, timestamp-based feature extraction, anomaly detection
- ML Workflow — Dataset → Preprocessing → Model → Evaluation → Improvement
...
- **Spring Boot** — REST APIs, Layered Architecture (Controller → Service → Repository), DTO Pattern, Exception Handling
